...
export const SERVICES: Service[] = [ 
    ...
    { id:5, route:'floor-plans', title:'FLOOR PLAN REDRAWS', thumb:'https://d1dbtne32ilur4.cloudfront.net/img/categories/floorPlansB.jpg', description:'Clearly showcase your listing to potential buyers with an online floorplan available in a range of 2D and 3D options.' },
    ...
    { id:7, route:'virtul-staging', title:'360° VIRTUAL STAGING', thumb:'https://d1dbtne32ilur4.cloudfront.net/img/categories/360VirtualStaging.jpg', description:'Our team of expert editors can add realistic furniture to 360° images to bring to life a previously bare listing.' },
